...
<div class="card-body login-card-body">
    <div class="card-body login-card-body">
        <p class="login-box-msg"><strong>Register Your Shop Here</strong></p>
        @if($errors->any())
        <p class="login-box-msg" style="color:green">{{$errors->first()}}</p>
        @endif
        ...
        <form action="{{ route('pre_registration.save') }}" method="post">
            {!! csrf_field() !!}

            <div class="input-group mb-3">
                <input value="{{ old('name') }}" type="text" class="form-control" name="user_name" placeholder="User Name" aria-label="" required>
            ...
            <div class="input-group mb-3">
                <input value="{{ old('email') }}" type="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" placeholder="{{ __('auth.email') }}" aria-label="{{ __('auth.email') }}" required>
                <div class="input-group-append">
            ...
            <div class="input-group mb-3">
                <input value="{{ old('phone_no') }}" type="text" class="form-control" name="phone_no" placeholder="Phone Number" aria-label="" required>
                <div class="input-group-append">
            ...
            <div class="input-group mb-3">
                <input value="{{ old('shop_name') }}" type="text" class="form-control" name="shop_name" placeholder="Shop Name" aria-label="" required>
                <div class="input-group-append">
            ...
            <div class="input-group mb-3">
                <input value="{{ old('shop_address') }}" type="text" class="form-control" name="shop_address" placeholder="Shop Address" aria-label="" required>
                <div class="input-group-append">
...
<script type="text/javascript">
   ...
   setTimeout(function(){ $('.alert alert-success').fadeOut() }, 5000);
});
</script>
@endsection