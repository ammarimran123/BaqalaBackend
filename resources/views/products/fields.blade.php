        ...
        <script type="text/javascript">
            ...
            var dz_var15671147171873255749ble = $(".dropzone.image").dropzone({
                    ...
                    maxfilesexceeded: function (file) {
                        console.log('inside maxfilesexceeded');
...
<!-- Price Field -->
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::number('price', null,  ['class' => 'form-control','placeholder'=>  trans("lang.product_price_placeholder"),'step'=>"0.01", 'min'=>"0"]) !!}
            <div class="form-text text-muted">
...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- Product Code Field -->
    <div class="form-group row ">
        {!! Form::label('product_code', trans("lang.product_code"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::number('product_code', null,  ['class' => 'form-control','placeholder'=>  trans("lang.product_code_placeholder"),'step'=>"any", 'min'=>"0"]) !!}
            <div class="form-text text-muted">
    ...
    <div class="form-group row ">
        {!! Form::label('product_barcode', trans("lang.product_barcode"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::number('product_barcode', null,  ['class' => 'form-control','placeholder'=>  trans("lang.product_code_placeholder"),'step'=>"any", 'min'=>"0"]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.product_barcode_help") }}
            </div>
        </div>
    </div>
