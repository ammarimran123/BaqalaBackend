...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    @hasanyrole('admin')
    <div class="form-group row ">
        {!! Form::label('drivers[]', trans("lang.market_delivery_time"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
        {!! Form::number('delivery_time', null,  ['class' => 'form-control', 'step'=>'any','placeholder'=>  trans("lang.market_delivery_range_placeholder")]) !!}
            <div class="form-text text-muted">{{ trans("lang.market_delivery_time_help") }}</div>
        </div>
    </div>
    @endhasanyrole
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::number('delivery_fee', null,  ['class' => 'form-control','step'=>'any','placeholder'=>  trans("lang.market_delivery_fee_placeholder"), 'disabled' => 'disabled',]) !!}
            <div class="form-text text-muted">
    ...
    <div class="form-group row ">
        {!! Form::label('min_order_amount', trans("Minimum Order Amount"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::text('min_order_amount', null,  ['class' => 'form-control','placeholder'=>  trans("Minimum Order Amount")]) !!}
            <div class="form-text text-muted">
                {{ trans("Minimum Order Amount") }}
            </div>
        </div>
    </div>
    <!-- @endhasanyrole
    ...
    @hasanyrole('admin') -->
    <div class="form-group row ">
        {!! Form::label('start_time', trans("Start Time"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::time('start_time', null,  ['class' => 'form-control','placeholder'=>  trans("Start Time")]) !!}
            <div class="form-text text-muted">
                {{ trans("Start time") }}
            </div>
        </div>
    ...
    <div class="form-group row ">
        {!! Form::label('end_time', trans("Close Time"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::time('end_time', null,  ['class' => 'form-control','placeholder'=>  trans("Close Time")]) !!}
            <div class="form-text text-muted">
                {{ trans("Close time") }}
            </div>
        </div>
