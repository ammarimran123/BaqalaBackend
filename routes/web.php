...
Route::get('/pusher', function() {
    event(new App\Events\importUpdateStatus('Hi there Pusher!'));
    return "Event has been sent!";
});

Route::get('','AppSettingController@initFirebase');

Route::get('pre-registration', 'PreRegisterController@register')->name('pre_registration');
Route::post('pre-registration/save', 'PreRegisterController@save')->name('pre_registration.save');

Route::post('deleteAllProducts/{id}', 'MarketController@deleteAllProducts')->name('markets.deleteAllProducts');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('serviceFees', 'ServiceFeesController@index')->name('serviceFees.index');
    // CUSTOM ROUTE
    ...
    Route::post('products/uploadCSV', 'ProductController@uploadCSV');
