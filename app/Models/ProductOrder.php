...
//        'options'
    ...
    //test to appent market with product in order
...
//    }
    ...
    protected static function boot()
    {
        ...
        ProductOrder::creating(function ($model) {
            ...
            $market=Market::where('id',$product[0]->market_id)->get();
            $model->product_name=$product[0]->name;
            $model->market_name=$market[0]->name;
        });
    }
